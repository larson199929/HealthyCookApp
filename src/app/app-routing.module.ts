...
const routes: Routes = [
  ...
  {path: 'beginner/listar', component: ListBeginnerComponent},
  {path: 'beginner/nuevo', component:CreateBeginnerComponent},
  {path: 'beginner/actualizar/:id', component: UpdateBeginnerComponent},
  {path: 'beginner/buscar', component: FindBeginnerComponent},
